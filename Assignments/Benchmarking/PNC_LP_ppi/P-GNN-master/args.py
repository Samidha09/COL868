...
def make_args():
    ...
    # dataset
    parser.add_argument('--remove_link_ratio',
                        dest='remove_link_ratio', default=0.2, type=float)
    ...
    parser.add_argument('--output_dim', dest='output_dim',
                        default=32, type=int)
    parser.add_argument('--anchor_num', dest='anchor_num',
                        default=64, type=int)
    ...
    parser.add_argument('--repeat_num', dest='repeat_num',
                        default=1, type=int)  # 10
