                ...
                if epoch % args.epoch_log == 0:
                    ...
                    for id, data in enumerate(data_list):
                        ...
                        f1_train += f1_score(label.flatten().cpu().numpy(),
                                             (out_act(pred) > 0.7).flatten().data.cpu().numpy())
                    ...
                    print(repeat, epoch, 'Loss {:.4f}'.format(loss_train), 'Train F1: {:.4f}'.format(f1_train),
                          'Val F1: {:.4f}'.format(f1_val), 'Test F1: {:.4f}'.format(f1_test))
                    print(repeat, epoch, 'Loss {:.4f}'.format(loss_train), 'Train Precision: {:.4f}'.format(prec_train),
                          'Val Precision: {:.4f}'.format(prec_val), 'Test Precision: {:.4f}'.format(prec_test))
                    print(repeat, epoch, 'Loss {:.4f}'.format(loss_train), 'Train Recall: {:.4f}'.format(recall_train),
